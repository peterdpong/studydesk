...
import { deleteClass, deleteSyllabus, deleteFile } from '../../../lib/firestoredb';
    ...
    <Box>
        ...
        <Box ml={{md: 10, base: 2}}>
            ...
            <Flex mt={5} align="center">
                {currentClass[0].syllabus ? 
                    <Flex>
                        ...
                        <DeletePopover 
                            ...
                            deleteHandler={() => {deleteFile(currentClass[0].syllabus); deleteSyllabus(auth!.uid, auth!.classes!, className ? className : "");}}
                ...
                <SyllabusModal isOpen={isUploadOpen} onClose={onUploadClose} name={className} uid={auth!.uid} classes={auth!.classes}/>
            </Flex>
            ...
            <Box w={{md: "50%", sm: "70%", base: "100%"}}>
                <Flex mt={10}>
                    ...
                    <Box mt={3}>
                        ...
                        <ClassTimeModal isOpen={isTimeOpen} onClose={onTimeClose} name={className} uid={auth!.uid} classes={auth!.classes}/>
                    </Box>
                </Flex>
                <Box overflowX={{base: "auto", sm: "initial"}} w={{base: "90%", md: "100%"}}>
                    <ClassTimesTable times={currentClass[0].classTimes} name={className} uid={auth!.uid} classes={auth!.classes} />
                </Box>
            </Box>
            ...
            <Box w={{md: "60%", sm: "80%"}} mb={10}>
                <Flex mt={10}>
                    ...
                    <Box mt={3}>
                        ...
                        <AssignmentModal isOpen={isAssignmentOpen} onClose={onAssignmentClose} name={className} uid={auth!.uid} classes={auth!.classes} />
                    </Box>
                </Flex>
                <Box overflowX={{base: "auto", sm: "initial"}} w={{base: "90%", md: "100%"}}>
                    <AssignmentTable assignments={currentClass[0].assignments} name={className} uid={auth!.uid} classes={auth!.classes} />
                </Box>
                <Center>
