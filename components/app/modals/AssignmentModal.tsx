...
export default function AssignmentModal(props: { isOpen: boolean, onClose: () => void, name: string | undefined, uid: string | undefined, classes: ClassModel[] | undefined }) {
    ...
    return (
        <Modal isOpen={props.isOpen} onClose={props.onClose}>
            ...
            <ModalFooter>
                <Button colorScheme="blue" mr={3} onClick={(e) => submitHandler(e, props.name ? props.name : "")}>
                    Submit
                </Button>
